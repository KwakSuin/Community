...
public class QuestList extends Fragment {
    private QuestWrite write;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        boardList.add(new QuestBoard("3","중성화 수술은 언제하나요?","언제하나요?","모모주인"));
        boardList.add(new QuestBoard("0","치와와 간식 추천해주세요!","추천해주세요!","복희"));
        boardList.add(new QuestBoard("5","다들 옷은 어디서 구매하세요?","1살된 강아지 옷이요!","장군"));
        boardList.add(new QuestBoard("8","수도권 애견카페 추천 해주실 수 있나요?","서울, 경기 쪽이요!","소녀"));
